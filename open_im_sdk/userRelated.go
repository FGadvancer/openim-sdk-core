...
func (u *LoginMgr) initResources() {
	...
	u.friend = friend.NewFriend(u.db, u.user, u.conversationCh)
	u.group = group.NewGroup(u.db, u.conversationCh)
	u.conversation = conv.NewConversation(ctx, u.longConnMgr, u.db, u.conversationCh,
		u.friend, u.group, u.user, u.conversationListener, u.advancedMsgListener, u.business, u.full, u.file)
	u.user = user.NewUser(u.db, u.conversationCh)
	u.file = file.NewFile(u.db)
	u.business = business.NewBusiness(u.db)

	u.msgSyncer, _ = interaction.NewMsgSyncer(ctx, u.conversationCh, u.pushMsgAndMaxSeqCh, u.longConnMgr, u.db, 0)
	u.full = full.NewFull(u.user, u.friend, u.group, u.conversationCh, u.db)
	u.third = third.NewThird(u.info.PlatformID, constant.SdkVersion, u.info.LogFilePath, u.file)
	...
	u.initLogin = login.NewInitLogin(u.friend, u.group, u.conversation, u.user, u.file, u.business, u.third, u.full,
		u.db, u.longConnMgr, u.info,u.msgSyncer,u.loginMgrCh)
}
